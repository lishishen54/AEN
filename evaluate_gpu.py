...
#     if i == 0:
#         _ = query_feature[:55, :]
#         feature = torch.mean(_, dim=0).unsqueeze(dim=0)
#         _ = query_label[temp-1]
#         label.append(_)
#     else:
#         _ = torch.mean(query_feature[temp - 54:temp, :], dim=0).unsqueeze(dim=0)
#         feature = torch.cat((feature, _), dim=0)
#         _ = query_label[temp-1]
#         label.append(_)

#     temp = temp+54

# mutli_query_feature = feature
# mutli_query_label = label
...
# # 多查询
# query_feature = mutli_query_feature.cuda(0)
# query_label = mutli_query_label
# gallery_feature = gallery_feature.cuda(0)
